...
const TdeeCalculator = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-stretch w-full rounded-lg overflow-hidden gap-6 text-white shadow-lg">
      <Card
        className="p-6 w-full flex-1 text-sm  rounded-lg shadow-md"
      ...
      >
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full p-2 border border-green-500 rounded bg-gray-700"
          >
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full p-2 border rounded bg-gray-700 border-green-500"
          >
        ...
        <Button
          ...
          className="bg-gradient-to-br from-gray-950  to-gray-800 text-green-400  shadow-md shadow-green-400/50 mt-4 rounded-lg"
        />
      </Card>

      {tdee && (
        <Card
          className="p-6 w-full flex-1 text-sm  rounded-lg shadow-md justify-center items-center text-center"
          title="Your Results"
          description="Your calculated BMR, TDEE, BMI, and macronutrients."
        >
          ...
          <div className="mt-6">
            ...
            <p className="mt-2">
              ...
              <span className="text-red-400">{macros?.protein.toFixed(2)}</span>{" "}
              grams
            </p>
            <p>
              <strong>Carbs:</strong>{" "}
              <span className="text-blue-400">{macros?.carbs.toFixed(2)}</span>{" "}
              grams
            </p>
            <p>
              <strong>Fat:</strong>{" "}
              <span className="text-yellow-400">{macros?.fat.toFixed(2)}</span>{" "}
              grams
            </p>
          </div>
        </Card>
