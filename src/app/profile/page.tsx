...
const Profile = () => {
  ...
  return (
    <div className="relative mt-8 md:mt-0 flex flex-col justify-start items-center text-center gap-10 px-6 py-10 min-h-[100dvh] bg-cover bg-center bg-no-repeat">
